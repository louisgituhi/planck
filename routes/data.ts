export const physicistsData = [
    ...
    // Albert Einstein
    {
        ...
        "description": "This a description for Albert Einstaein",
        "nationality": "Ulm, Wurttemberg, Germany",
        "awards_and_honors": ["Copley Medal (1925)","Nobel prize (1921)"],
        "year_born": 1879,
        "year_died": 1955,
        "discovery": [
            ...
            "Discovered the hugely important and iconic equation E = mc2",
            "Relativity"
        ]
    },
    ...
    // Alhazen
    {
        ...
        "name": "Alhazen",
        "description": "lkdjhbvnwndbmsncldjfbcj",
        "nationality": "City of Basra in the Buyid emirate, now in Iraq.",
        "year_born": 965, 
        "year_died": 1040,
        "discovery": [
            "Explained why camera images are upside down; solved ‘Alhazen’s problem’ concerning reflection of light from curved surfaces",
            "Discovered a general method to find the sum of any integral power. "
        ]
    },
    ...
    // Andre-Marie Ampere
    {
        ...
        "discovery": [
            ...
            "He went on to formulate Ampere’s Law of electromagnetism and produced the best definition of electric current of his time",
            "Electromagnetism and produced the best definition of electric current of his time."
        ]
    },
    ...
    // Archimedes
    {
        ...
        "name": "Archimedes",
        "description": "lkdjhbvnwndbmsncldjfbcj",
        "nationality": "Greek city-state of Syracuse on the island of Sicily",
        "year_born": 287, 
        "year_died": 212,
        "discovery": [
            "Invented the sciences of mechanics and hydrostatics",
            "Discovered the laws of levers and pulleys",
            "Calculated PI to the most precise value known",
            ...
            "Invented war machines such as a highly accurate catapult that stopped the Romans conquering Syracuse for years"
        ]
    },
    ...
    // Aristotle
    {
        ...
        "name": "Aristotle",
        "description": "lkdjhbvnwndbmsncldjfbcj",
        "nationality": "City of Stagira in the Greek state of Macedonia.",
        "year_born": 384, 
        "year_died": 322,
        "discovery": [
    ...
    // Benjamin Franklin
    {
        ...
        "year_died": 1790,
        "discovery": [
            "He invented the Bifocal Spectacles, The Franklin Stove, The Lightning Rod, Shaping our understanding of electricity, Refrigeration and founded the American Philosophical Society"
        ]
    },
    ...
    // Carl Friedrich Gauss
    {
        ...
        "nationality": "Brunswick, Germany",
        "awards_and_honors": ["Copley Medal (1838)"],
        "year_born": 1777, 
        "year_died": 1855,
        "discovery": [
            "Geometry",
